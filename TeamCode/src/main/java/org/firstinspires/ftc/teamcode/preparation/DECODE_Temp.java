package org.firstinspires.ftc.teamcode.preparation;
...
public class DECODE_Temp extends LinearOpMode {
    long lastNanoTime;
    ...
    public double NAllowHeadingSpeed;
    public boolean AllowHeading= true;
...
//        }
        ...
        if(!AllowHeading){
            NAllowHeadingSpeed=1000*gamepad2.left_trigger;//todo 检查此处值域转换
        }

        if(!AllowHeading&gamepad2.left_trigger>0.6){
            ManualShoot=!ManualShoot;
            if(ManualShoot){
                targetSpeed=NAllowHeadingSpeed;
            }
        }
